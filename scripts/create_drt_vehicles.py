"""
Create DRT vehicles for Jeonggwan scenario
Generates DVRP vehicle fleet XML file
"""
import xml.etree.ElementTree as ET
from xml.dom import minidom
import random

# DRT Vehicle Configuration
NUM_VEHICLES = 20      # Number of DRT vehicles
...
# Random sample for vehicle start positions
random.seed(42)
...
# Write to file
output_file = 'input/jeonggwan-drt-vehicles.xml'
